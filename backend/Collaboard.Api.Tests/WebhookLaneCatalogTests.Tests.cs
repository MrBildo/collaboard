...
public sealed class WebhookLaneCatalogTests : IClassFixture<WebhookTestFactory>, IDisposable
{
    ...
    public async Task McpCreateLane_FiresLaneCreated()
    {
        ...
        var result = await tools.CreateLaneAsync(CollaboardApiFactory.TestAdminAuthKey, _factory.DefaultBoardId, "Mcp Lane", position);
    ...
    public async Task McpUpdateLaneName_FiresLaneRenamed()
    {
        ...
        (await tools.UpdateLaneAsync(CollaboardApiFactory.TestAdminAuthKey, laneId, name: "mcp-renamed")).ShouldNotContain("Error");
    ...
    public async Task McpUpdateLanePosition_FiresLaneReordered_WithFullNewOrder()
    {
        ...
        (await tools.UpdateLaneAsync(CollaboardApiFactory.TestAdminAuthKey, laneId, position: target)).ShouldNotContain("Error");
    ...
    public async Task McpUpdateLaneNameAndPosition_CoFiresRenamedAndReordered()
    {
        ...
        (await tools.UpdateLaneAsync(CollaboardApiFactory.TestAdminAuthKey, laneId, name: "mcp-cofired", position: target)).ShouldNotContain("Error");
    ...
    public async Task McpReorderLanes_FiresOneLaneReordered_FullNewOrder()
    {
        ...
        (await tools.ReorderLanesAsync(CollaboardApiFactory.TestAdminAuthKey, _factory.DefaultBoardId, csv)).ShouldNotContain("Error");
    ...
    public async Task McpDeleteLane_FiresLaneDeleted()
    {
        ...
        (await tools.DeleteLaneAsync(CollaboardApiFactory.TestAdminAuthKey, laneId)).ShouldNotContain("Error");
