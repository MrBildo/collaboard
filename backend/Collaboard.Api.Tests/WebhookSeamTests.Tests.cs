...
public sealed class WebhookSeamTests(WebhookTestFactory factory) : IClassFixture<WebhookTestFactory>, IDisposable
{
    ...
    public async Task RestAndMcpCreate_ProduceIdenticalEnvelopeAndDataFieldSet()
    {
        ...
        var mcpResult = await tools.CreateCardAsync(CollaboardApiFactory.TestAdminAuthKey, "Parity MCP", laneId);
    ...
    public async Task McpMoveCard_FiresCardMoved_WithFromTo()
    {
        ...
        var result = await tools.MoveCardAsync(CollaboardApiFactory.TestAdminAuthKey, laneB, cardId: cardId, index: 0);
    ...
    public async Task McpUpdateCardWithLaneId_FiresCardMoved_WithFromTo()
    {
        ...
        var result = await tools.UpdateCardAsync(CollaboardApiFactory.TestAdminAuthKey, cardId: cardId, laneId: laneB);
        result.ShouldNotContain("Error");
    ...
    public async Task UpdateWithoutLaneChange_FiresNoCardMoved()
    {
        ...
        var nameResult = await tools.UpdateCardAsync(CollaboardApiFactory.TestAdminAuthKey, cardId: cardId, name: "Renamed");
