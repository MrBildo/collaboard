...
// The REST and MCP management surfaces translate it to a 400 / tool-error; the store tests assert
// the throw. Distinct from WebhookSsrfBlockedException, which is
