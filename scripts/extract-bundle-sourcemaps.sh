...
#   packaged (silently shipping our own source layout). So both directions are
#   asserted here, and verify-archive.sh independently rejects any .map that
#   reaches a packaged archive.
#
...
echo "Moved ${#found[@]} sourcemap(s) out of '${DIST}' into '${MAPS}'; the build output holds none."
